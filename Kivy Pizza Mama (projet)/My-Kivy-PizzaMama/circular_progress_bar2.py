...
# Ref. https://stackoverflow.com/questions/50543028/how-to-make-circular-progress-bar-in-kivy
# @author: Kacper Floriański
...
class CircularProgressBar(ProgressBar):
    ...
    def refresh_text(self):
        # Render the label
        self.label.refresh()   # see https://kivy.org/doc/stable/api-kivy.core.text.html
