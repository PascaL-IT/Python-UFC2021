...
class MyPopupProgressBar(Widget):
    ...
    def __init__(self, **kwa):
        ...
        self.popup = Popup(title='A Title Here.....', content=self.progress_bar)  # progress bar assigned to popup
    ...
    def puopen(self, instance):  # Called from bind.
        Clock.schedule_interval(self.next, .005)  # Creates Clock event scheduling next() every 5-100th of a second.
